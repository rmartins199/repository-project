...
function is_input_empty(string $email, string $passwordhash, string $first_name, string $last_name, string $dateb, int $user_number)
{
	if (empty($email) || empty($passwordhash) || empty($first_name) || empty($last_name) || empty($dateb) || empty($user_number)) {
		return true;
	}
	else{
		return false;
...
// -- TABELA UNICA --
function create_user(object $pdo, string $email, string $passwordhash, string $first_name, string $last_name, string $dateb, int $user_number) 
{
	set_login($pdo, $email, $passwordhash, $first_name, $last_name, $dateb, $user_number);
